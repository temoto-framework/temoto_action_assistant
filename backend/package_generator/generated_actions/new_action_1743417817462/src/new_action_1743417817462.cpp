#include "new_action_1743417817462/temoto_action.hpp"

class NewAction_1743417817462 : public TemotoAction
{
public:
...
}; // NewAction_1743417817462 class

// REQUIRED, do not remove
boost::shared_ptr<ActionBase> factory()
{
    return boost::shared_ptr<NewAction_1743417817462>(new NewAction_1743417817462());
}

// REQUIRED, do not remove
BOOST_DLL_ALIAS(factory, NewAction_1743417817462)