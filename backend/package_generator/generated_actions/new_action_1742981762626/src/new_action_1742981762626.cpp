#include "new_action_1742981762626/temoto_action.hpp"

class NewAction_1742981762626 : public TemotoAction
{
public:
...
}; // NewAction_1742981762626 class

// REQUIRED, do not remove
boost::shared_ptr<ActionBase> factory()
{
    return boost::shared_ptr<NewAction_1742981762626>(new NewAction_1742981762626());
}

// REQUIRED, do not remove
BOOST_DLL_ALIAS(factory, NewAction_1742981762626)