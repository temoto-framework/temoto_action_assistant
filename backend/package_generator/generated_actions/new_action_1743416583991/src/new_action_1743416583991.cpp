#include "new_action_1743416583991/temoto_action.hpp"

class NewAction_1743416583991 : public TemotoAction
{
public:
...
}; // NewAction_1743416583991 class

// REQUIRED, do not remove
boost::shared_ptr<ActionBase> factory()
{
    return boost::shared_ptr<NewAction_1743416583991>(new NewAction_1743416583991());
}

// REQUIRED, do not remove
BOOST_DLL_ALIAS(factory, NewAction_1743416583991)